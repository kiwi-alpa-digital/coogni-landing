...
export default async function handler(req, res) {
  ...
  try {
    ...
    console.log('[Coogni] Email:', email, '| API Key:', apiKey ? 'SET' : 'MISSING', '| Audience:', audienceId || 'NOT SET')
    ...
    const htmlContent = '<div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 40px 20px; color: #1e293b;">' +
